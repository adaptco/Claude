...
class TestByteSamplerDeterminism:
    ...
    def test_seed_derivation_deterministic(self):
        ...
        sampled = adapter.sample_next_bytes(b"test")
        ...
        assert derived_seed == expected_seed, \
            f"Seed derivation diverged: {derived_seed} vs {expected_seed}"
...
class TestValidCoveringTreeExactness:
    ...
    def test_marginalization_exactness(self):
        ...
        for byte_seq in manual_dist:
            manual_prob = manual_dist[byte_seq]
            bytesampler_prob = bytesampler_dist.distributions.get(byte_seq, 0)
            
            assert abs(manual_prob - bytesampler_prob) < 1e-10, \
...
class TestEdgeCases:
    ...
    def test_empty_prefix(self):
        ...
        try:
            ...
            pytest.fail(f"Failed on empty prefix: {e}")
    ...
    def test_very_long_prefix(self):
        ...
        try:
            ...
            pytest.fail(f"Failed on long prefix: {e}")
